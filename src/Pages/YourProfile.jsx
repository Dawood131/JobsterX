...
export default function ProfilePage() {
  return (
    <div className="min-h-screen flex flex-col items-center px-4 md:pt-0 pt-12 sm:px-6 md:px-8 bg-white">
      ...
      <p className="text-gray-700 text-center mb-5 text-base sm:text-lg">
        ...
        <div className="flex-1 text-center md:text-left">
          <div className="flex flex-col sm:flex-row items-center md:items-start gap-2 sm:gap-3">
            <div className="flex items-center gap-2">
              ...
              <span className="bg-[#3A0CA31A] text-[#3A0CA3] px-3 py-[2px] text-xs font-semibold rounded-full">
                Active
              </span>
            </div>
          </div>

          <p className="text-[#3A0CA3] mt-2 text-[16px] font-bold">
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          <User style={{ color: "rgba(58, 12, 163, 1)" }} size={26} />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            ...
            >
              <item.icon style={{ color: "rgba(58, 12, 163, 1)" }} size={26} />
              <div>
                <h3 className="text-gray-800 text-[15px]">{item.label}</h3>
                <p className="text-gray-800 font-bold break-all">{item.value}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          <Briefcase style={{ color: "rgba(58, 12, 163, 1)" }} size={26} />
          <h2 className="text-2xl font-bold text-gray-800">
