    ...
    <div className="min-h-screen flex flex-col items-center px-4 pt-12 md:pt-0 sm:px-6 md:px-8 bg-white">
        ...
        <div className="flex-1 text-center md:text-left">
          <div className="flex flex-col sm:flex-row items-center md:items-start gap-2 sm:gap-3">
            <div className="flex items-center gap-2">
              <h2 className="text-[21.49px] font-bold text-gray-800">Dawood Butt</h2>
          ...
          <p className="text-[#5B5B5B] mt-3 text-[15px] font-medium leading-relaxed">
            Creative Frontend Developer with expertise in HTML, CSS, JavaScript, React.js, and Tailwind CSS. Passionate
            about building responsive, user-friendly websites and web applications, with a strong focus on problem-solving,
      ...
      <div className="bg-white rounded-xl w-full max-w-[960px] p-6 sm:p-8 mb-10 shadow-[0_4px_10px_rgba(0,0,0,0.15)]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            { icon: Mail, label: "Email", value: "buttdaud94@gmail.com" },
            { icon: Phone, label: "Phone", value: "+92 3084161568" },
            { icon: MapPin, label: "Location", value: "Lahore, Pakistan" },
            { icon: Linkedin, label: "LinkedIn", value: "linkedin.com/in/dawoodbutt" },
          ].map((item, index) => (
            <div
              key={index}
      ...
      <div className="bg-white rounded-xl w-full max-w-[960px] p-6 sm:p-8 mb-10 shadow-[0_4px_10px_rgba(0,0,0,0.15)]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            { icon: PiBuildingBold, label: "Company", value: "System Limited" },
            { icon: Layers, label: "Department", value: "Engineering" },
            { icon: LiaUserTieSolid, label: "Designation", value: "Frontend Developer" },
            { icon: Calendar, label: "Join Date", value: "August 2025" },
          ].map((item, index) => (
            <div
              key={index}
              className="p-4 rounded-xl flex items-center gap-4 hover:scale-[1.02] transition-all duration-300"
