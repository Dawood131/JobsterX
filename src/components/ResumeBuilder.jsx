          ...
          <div className="w-full">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
              <div>
                ...
                <p className="text-[10px] sm:text-[15px] md:text-[16px] mx-auto w-fit text-[#6B7280] leading-normal mt-1">
              ...
              <button
                onClick={onOpenModal}
                className="mt-1 md:mt-0 px-3 py-2 text-sm sm:px-6 sm:py-2.5 sm:text-[14px] rounded-xl bg-[#680eb1] text-white font-medium hover:bg-[#680eb1c9] transition w-[110%] sm:w-[50%] md:w-auto self-center md:self-auto mb-3"
              >
