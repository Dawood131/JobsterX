      ...
      <div className="flex-1 flex flex-col p-4 sm:p-6 md:p-8 md:-mt-12 mt-6">
        <header>
          <div className="w-full">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 bg-[#4361EE1A] px-4 py-3 rounded-xl">
              <div>
              ...
              <button
                onClick={onOpenModal}
                className="mt-1 md:mt-auto px-3 py-2 text-sm sm:px-6 sm:py-2.5 sm:text-[14px] rounded-xl bg-gradient-to-r from-[#3A0CA3] to-[#7209B7] hover:from-[#6909aa] transition-all duration-300 text-white font-medium  w-[110%] sm:w-[50%] md:w-auto self-center md:self-auto mb-3 cursor-pointer"
              >
